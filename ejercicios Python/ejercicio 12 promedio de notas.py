...
nota_1_math = float(input("Ingrese nota 1 de matemáticas: "))
nota_2_math = float(input("Ingrese nota 2 de matemáticas: "))
nota_3_math = float(input("Ingrese nota 3 de matemáticas: "))

examen_fisica = float(input("Ingrese su calificación del examen final de física: "))
nota_1_fisica = float(input("Ingrese nota 1 de física: "))
nota_2_fisica = float(input("Ingrese nota 2 de física: "))

examen_quimica = float(input("Ingrese su calificación del examen final de química: "))
nota_1_quimica = float(input("Ingrese nota 1 de química: "))
nota_2_quimica = float(input("Ingrese nota 2 de química: "))
nota_3_quimica = float(input("Ingrese nota 3 de química: "))
